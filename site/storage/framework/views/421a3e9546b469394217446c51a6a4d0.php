...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('cliente')); ?>">
...
<?php /**PATH C:\Users\si\Desktop\Matérias 4 termo\laravel\laravel\site\resources\views/template_admin/index.blade.php ENDPATH**/ ?>